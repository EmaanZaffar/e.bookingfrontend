        ...
        <Card.Content className="flex md:flex-col xl:flex-row md:items-center md:text-center pl-0 md:p-2 md:gap-2 md:py-4 lg:py-3">
          ...
          <div className="mt-1 text-base lg:text-center xl:text-left">
            ...
            <div className="py-1 md:px-1">
              Enjoy flexible booking with no upfront charges-plus, cancel for
              free on most listings.
            </div>
          </div>
        </Card.Content>
      </Card>
      ...
      <Card className="w-full max-w-[550px] shadow-none hover:shadow-md rounded-md">
        <Card.Content className="flex md:flex-col xl:flex-row md:items-center md:text-center pl-0 md:p-2 md:gap-2 md:py-4 lg:py-3">
          ...
          <div className="mt-1 text-base lg:text-center xl:text-left">
            ...
            <div className="py-1 md:px-1">
              From nice hotels to comfy places and friendly guesthouses-we've
              got your stay.
            </div>
          </div>
        </Card.Content>
      ...
      <Card className="w-full max-w-[550px] shadow-none hover:shadow-md rounded-md">
        <Card.Content className="flex md:flex-col xl:flex-row md:items-center md:text-center pl-0 md:p-2 md:gap-2 md:py-4 lg:py-3">
          ...
          <div className="mt-1 text-base lg:text-center xl:text-left">
            ...
            <div className="py-1 md:px-1">
              Whether day or night, our dedicated customer care team is just a
              message away.
            </div>
          </div>
        </Card.Content>
